...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Za(){return new gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fs(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Ja(){return new gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fs(),fragmentShader:`
...
`].filter(Pi).join(`
`)),a=Ts(a),a=oo(a,t),a=lo(a,t),o=Ts(o),o=oo(o,t),o=lo(o,t),a=co(a),o=co(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
